...
const (
	...
	defaultMaxBodyBytes   = 100 << 20 // 100 MB, the largest single request body we accept (also the per-chunk cap).
	defaultMaxUploadBytes = 1 << 30   // 1 GB, the largest reassembled chunked upload (e.g. a big .apkg) we accept.
